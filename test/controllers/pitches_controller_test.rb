...
class PitchesControllerTest < ActionController::TestCase
  ...
  test "should create pitch" do
    assert_difference('Pitch.count') do
      post :create, pitch: { author: @pitch.author, company_name: @pitch.company_name, pitch_name: @pitch.pitch_name, sector_name: @pitch.sector_name, subsector_name: @pitch.subsector_name }
    end
  ...
  test "should update pitch" do
    patch :update, id: @pitch, pitch: { author: @pitch.author, company_name: @pitch.company_name, pitch_name: @pitch.pitch_name, sector_name: @pitch.sector_name, subsector_name: @pitch.subsector_name }
    assert_redirected_to pitch_path(assigns(:pitch))
  end
