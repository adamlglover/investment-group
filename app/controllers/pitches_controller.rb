class PitchesController < ApplicationController
  ...
  # GET /pitches.json
  def index
    pitches_scope = Pitch.order(:pitch_name)
    pitches_scope = pitches_scope.like(params[:filter]) if params[:filter]
    @pitches = smart_listing_create(:pitches, pitches_scope, partial: "pitches/pitch" )
  end
